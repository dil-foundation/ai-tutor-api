...
@router.post(
    ...
    summary="Stage 1 - Exercise 3: Evaluate Dialogue Response",
    description=(
        "Listen and Reply - Functional Dialogue: Accepts user's spoken reply to the dialogue, transcribes it, and evaluates the response using GPT. "
        "Feedback includes fluency, keyword relevance, and conversational appropriateness. Also returns the ID of the next dialogue."
    )
)
